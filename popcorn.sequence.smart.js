...
(function( global, Popcorn ) {
    ...
    function videoTransition(i, parent){
        videos[i-1].on( "timeupdate", function() {
            ...
            if(this.media.currentTime >= (sequence[i-1].out - (fadeTime/1000))){
                this.off("timeupdate");
                var nextVid = doc.getElementById('popcorn_sequence_smart_video_'+(i));
                ...
                try{
                    ...
                    console.log('popcorn.sequence.smart: last video playing');
    ...
    Popcorn.sequence.smart = function( parent, list, audio_src ) {
		return new Popcorn.sequence.smart.init( parent, list, audio_src );
  };

  Popcorn.sequence.smart.init = function( parent, list, audio_src ) {
	// Video container
